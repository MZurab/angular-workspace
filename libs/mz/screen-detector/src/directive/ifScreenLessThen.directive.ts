...
/* @example №1 - <div *ifScreenLessThen='700'></div> */
/* @example №2 - <div *ifScreenLessThen='700,300'></div> */

@Directive({ selector: '[ifScreenLessThen]' })
export class IfScreenLessThenDirective {
  @Input('ifScreenLessThen') public ifScreenLessThen: string;
  ...
  ngOnInit() {
    this.safeSetParams(this.ifScreenLessThen);
